...
Lines::Lines(float x, float y, color_t color, int angle) {
    ...
    this->lines_bbox.height = 2;
    this->lines_bbox.width = 24;
    this->lines_bbox.x = x;
    this->lines_bbox.y = y;
    ...
    static const GLfloat vertex_buffer_data2[] = {
        ...
        1.0f, -1.0f, 0.0f,
        20.0f, 1.0f, 0.0f, // triangle 1 : end
        1.0f, -1.0f , 0.0f, // triangle 2 : begin
        20.0f, 1.0f, 0.0f,
        20.f, -1.0f, 0.0f, // triangle 2 : end
    ...
    for (int i = 0; i < n; i++) 
    {
        vertex_buffer_data3[k++] =  21.0f;
        vertex_buffer_data3[k++] = 0.0f;
        vertex_buffer_data3[k++] = 0.0f;
        
        vertex_buffer_data3[k++] =  21 + cos(i*theta) * 1.0f;
        vertex_buffer_data3[k++] = sin(i*theta) * 1.0f;
        vertex_buffer_data3[k++] = 0.0f;
        
        vertex_buffer_data3[k++] =  21 + cos((i+1)*theta) * 1.0f;
...
void Lines::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Lines::tick() {
    // printf("Lines- %f %f\n", this->lines_bbox.x, this->lines_bbox.y);
    this->lines_bbox.x = this->position.x;
    this->lines_bbox.y = this->position.y;
}