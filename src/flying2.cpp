...
Flying2::Flying2(float x, float y, color_t color) {
    this->position = glm::vec3(x, y, 0);
    this->rotation = 0;
    this->velocity = 4;
    this->flying2_bbox.height = 6;
    this->flying2_bbox.width = 6;
    this->flying2_bbox.x = x;
    this->flying2_bbox.y = y;
    this->flag = 1;
...
void Flying2::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Flying2::tick() {
    this->position.x -= 0.5;
    this->flying2_bbox.x = this->position.x;
    this->flying2_bbox.y = this->position.y;
    // printf("%f\n", this->position.y);
